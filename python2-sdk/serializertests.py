...
class SemantriaSerializerTest(unittest.TestCase):
    def test_XmlSerializingConfiguration(self):
        ...
        <facets_limit>15</facets_limit></collection><document>\n\
        ...
        self.assertEquals(expectedResult, serializer.serialize(proxy, {"root":"configurations", "added":"configuration", "removed":"configuration"}))
    ...
    def test_XmlDeserializingConfiguration(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        configs = serializer.deserialize(source, GetConfigurationsHandler())
        config = configs[0]
        ...
        self.assertEquals("English", config['language']);
        self.assertEquals(80, config['chars_threshold']);
        self.assertEquals("https://anyapi.anydomain.com/processed/docs.json", config['callback']);

        self.assertEquals(7, config['document']['concept_topics_limit']);
        self.assertEquals(25, config['document']['query_topics_limit']);
        self.assertEquals(100, config['document']['named_entities_limit']);
        self.assertEquals(5, config['document']['user_entities_limit']);
        self.assertEquals(10, config['document']['themes_limit']);
        self.assertEquals(5, config['document']['entity_themes_limit']);
        self.assertEquals(1, config['document']['phrases_limit']);
        self.assertEquals(0, config['document']['summary_limit']);

        self.assertEquals(5, config['collection']['concept_topics_limit']);
        self.assertEquals(5, config['collection']['query_topics_limit']);
        self.assertEquals(5, config['collection']['named_entities_limit']);
        self.assertEquals(0, config['collection']['themes_limit']);
        self.assertEquals(15, config['collection']['facets_limit']);
        self.assertEquals(20, config['collection']['facet_atts_limit']);
    ...
    def test_JsonDeserializingConfiguration(self):
        ...
        self.assertEquals("default", config['name']);
        self.assertFalse(config['is_primary']);
        self.assertFalse(config['one_sentence']);
        self.assertFalse(config['auto_responding']);
        self.assertEquals("English", config['language']);
        self.assertEquals(80, config['chars_threshold']);
        self.assertEquals("https://anyapi.anydomain.com/processed/docs.json", config['callback']);
    ...
    def test_XmlSerializingBlacklist(self):
        ...
        self.assertEquals(expectedResult, serializer.serialize(proxy, {"root":"blacklist", "added":"item", "removed":"item"}))
    ...
    def test_XmlDeserializingBlacklist(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        blacklists = serializer.deserialize(source, GetBlacklistHandler())

        self.assertEquals(2, len(blacklists));
        self.assertEquals("Filter 1", blacklists[0]);
        self.assertEquals("Filter 2", blacklists[1]);
    ...
    def test_JsonDeserializingBlacklist(self):
        ...
        self.assertEquals(2, len(blacklists));
        self.assertEquals(".*@.*com", blacklists[0]);
        self.assertEquals(".*@com\\.net", blacklists[1]);
    ...
    def test_XmlSerializingQueries(self):
        ...
        self.assertEquals(expectedResult, serializer.serialize(proxy, {"root":"queries", "added":"query", "removed":"query"}))
    ...
    def test_XmlDeserializingQueries(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        queries = serializer.deserialize(source, GetQueriesHandler())

        self.assertEquals(2, len(queries));
        self.assertEquals("Query 1", queries[0]["name"]);
        self.assertEquals("Something AND something", queries[0]["query"]);
        self.assertEquals("Query 2", queries[1]["name"]);
        self.assertEquals("Something AND something", queries[1]["query"]);
    ...
    def test_JsonDeserializingQueries(self):
        ...
        self.assertEquals(1, len(queries));
        self.assertEquals("Feature: Cloud service", queries[0]["name"]);
        self.assertEquals("Amazon AND EC2 AND Cloud", queries[0]["query"]);
    ...
    def test_XmlSerializingEntities(self):
        ...
        self.assertEquals(expectedResult, serializer.serialize(proxy, {"root":"entities", "added":"entity", "removed":"entity"}))
    ...
    def test_XmlDeserializingEntities(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        entities = serializer.deserialize(source, GetEntitiesHandler())

        self.assertEquals(1, len(entities));
        self.assertEquals("chair", entities[0]["name"]);
        self.assertEquals("furniture", entities[0]["type"]);
    ...
    def test_XmlSerializingCategories(self):
        ...
        self.assertEquals(expectedResult, serializer.serialize(proxy, {"root":"categories", "added":"category", "removed":"category", "samples":"sample"}))
    ...
    def test_XmlDeserializingCategories(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        categories = serializer.deserialize(source, GetCategoriesHandler())

        self.assertEquals(1, len(categories));
        self.assertEquals("Feature: Cloud service", categories[0]["name"]);
        self.assertEquals(0.75, categories[0]["weight"]);
        self.assertEquals(2, len(categories[0]["samples"]));
        self.assertEquals("Amazon", categories[0]["samples"][0]);
        self.assertEquals("EC2", categories[0]["samples"][1]);
    ...
    def test_XmlSerializingSentimentPhrases(self):
        ...
        self.assertEquals(expectedResult, serializer.serialize(proxy, {"root":"phrases", "added":"phrase", "removed":"phrase"}))
    ...
    def test_XmlDeserializingSentimentPhrases(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        phrases = serializer.deserialize(source, GetSentimentPhrasesHandler())

        self.assertEquals(1, len(phrases));
        self.assertEquals("chair", phrases[0]["title"]);
        self.assertEquals(0.3, phrases[0]["weight"]);
    ...
    def test_JsonDeserializingSentimentPhrases(self):
        ...
        self.assertEquals(1, len(phrases));
        self.assertEquals("chair", phrases[0]["title"]);
        self.assertEquals(0.75, phrases[0]["weight"]);
    ...
    def test_XmlDeserializingAnalyticServiceStatus(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        status = serializer.deserialize(source, GetStatusHandler())

        self.assertEquals("online", status["service_status"]);
        self.assertEquals("2.0", status["api_version"]);
        self.assertEquals("1.0.2.63", status["service_version"]);
        self.assertEquals("UTF-8", status["supported_encoding"]);
        self.assertEquals("gzip", status["supported_compression"]);
        self.assertEquals(2, len(status["supported_languages"]));
        self.assertEquals("English", status["supported_languages"][0]);
        self.assertEquals("French", status["supported_languages"][1]);
    ...
    def test_XmlDeserializingSubscription(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        subscription = serializer.deserialize(source, GetSubscriptionHandler())

        self.assertEquals("name", subscription["name"]);
        self.assertEquals("active", subscription["status"]);
        self.assertEquals("normal", subscription["priority"]);
        self.assertEquals(1293883200, subscription["expiration_date"]);
        self.assertEquals(87, subscription["calls_balance"]);
        self.assertEquals(100, subscription["calls_limit"]);
        self.assertEquals(60, subscription["calls_limit_interval"]);
        self.assertEquals(49897, subscription["docs_balance"]);
        self.assertEquals(0, subscription["docs_limit"]);
        self.assertEquals(0, subscription["docs_limit_interval"]);
        self.assertEquals(10, subscription["configurations_limit"]);
        self.assertEquals(100, subscription["blacklist_limit"]);
        self.assertEquals(100, subscription["categories_limit"]);
        self.assertEquals(100, subscription["queries_limit"]);
        self.assertEquals(1000, subscription["entities_limit"]);
        self.assertEquals(1000, subscription["sentiment_limit"]);
        self.assertEquals(8192, subscription["characters_limit"]);
        self.assertEquals(1, subscription["batch_limit"]);
        self.assertEquals(10, subscription["collection_limit"]);
        self.assertEquals(2, subscription["auto_response_limit"]);
        self.assertEquals(100, subscription["processed_batch_limit"]);
        self.assertEquals(100, subscription["callback_batch_limit"]);
        self.assertEquals("type limit", subscription["limit_type"]);
    ...
    def test_JsonDeserializingSubscription(self):
        ...
        self.assertEquals(1000, subscription["sentiment_limit"]);
        self.assertEquals(8192, subscription["characters_limit"]);
        self.assertEquals(10, subscription["batch_limit"]);
        self.assertEquals(10, subscription["collection_limit"]);
        self.assertEquals(2, subscription["auto_response_limit"]);
        self.assertEquals(100, subscription["processed_batch_limit"]);
        self.assertEquals(100, subscription["callback_batch_limit"]);
    ...
    def test_XmlDeserializingDocumentAnalyticData(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        doc = serializer.deserialize(source, GetDocumentHandler())

        # main
        self.assertEquals("23498367", doc['config_id']);
        self.assertEquals("6F9619FF8B86D011B42D00CF4FC964FF", doc['id']);
        self.assertEquals("PROCESSED", doc['status']);
        self.assertEquals(0.2398756, doc['sentiment_score']);
        self.assertEquals("Summary of the document's text.", doc['summary']);
        # themes
        self.assertEquals(1, len(doc['themes']));
        self.assertEquals(1, doc['themes'][0]['evidence']);
        self.assertTrue(doc['themes'][0]['is_about']);
        self.assertEquals(0, doc['themes'][0]['strength_score']);
        self.assertEquals(0, doc['themes'][0]['sentiment_score']);
        self.assertEquals('republican moderates', doc['themes'][0]['title']);
        # entities
        self.assertEquals(1, len(doc['entities']));
        self.assertEquals(0, doc['entities'][0]['evidence']);
        self.assertTrue(doc['entities'][0]['is_about']);
        self.assertTrue(doc['entities'][0]['confident']);
        self.assertEquals('named', doc['entities'][0]['type']);
        self.assertEquals(1.0542796, doc['entities'][0]['sentiment_score']);
        self.assertEquals('WASHINGTON', doc['entities'][0]['title']);
        # entity themes
        self.assertEquals(1, len(doc['entities'][0]['themes']));
        theme = doc['entities'][0]['themes'][0];
        self.assertEquals(1, theme['evidence']);
        self.assertTrue(theme['is_about']);
        self.assertEquals(0, theme['strength_score']);
        self.assertEquals(0, theme['sentiment_score']);
        self.assertEquals('republican moderates', theme['title']);
        # topics
        self.assertEquals(1, len(doc['topics']));
        self.assertEquals(0, doc['topics'][0]['hitcount']);
        self.assertEquals('concept', doc['topics'][0]['type']);
        self.assertEquals(0.6133076, doc['topics'][0]['strength_score']);
        self.assertEquals(0.6133076, doc['topics'][0]['sentiment_score']);
        self.assertEquals('Something', doc['topics'][0]['title']);
        # phrases
        self.assertEquals(1, len(doc['phrases']));
        self.assertEquals('not', doc['phrases'][0]['negating_phrase']);
        self.assertTrue(doc['phrases'][0]['is_negated']);
        self.assertEquals(0.6133076, doc['phrases'][0]['sentiment_score']);
        self.assertEquals('Something', doc['phrases'][0]['title']);
    ...
    def test_JsonDeserializingDocumentAnalyticData(self):
        ...
        serializer = semantria.JsonSerializer()
        session = semantria.Session("123", "123", serializer)
        docs = serializer.deserialize(source, GetDocumentHandler())
        ...
        self.assertEquals("PROCESSED", doc['status']);
        self.assertEquals(0.2398756, doc['sentiment_score']);
        self.assertEquals("Summary of the doc?ument's text.", doc['summary']);
        # themes
        self.assertEquals(1, len(doc['themes']));
        self.assertEquals(1, doc['themes'][0]['evidence']);
        self.assertTrue(doc['themes'][0]['is_about']);
    ...
    def test_XmlDeserializingCollectionAnalyticData(self):
        ...
        serializer = semantria.XmlSerializer()
        session = semantria.Session("123", "123", serializer)
        coll = serializer.deserialize(source, GetCollectionHandler())

        # main
        self.assertEquals("23498367", coll['config_id']);
        self.assertEquals("6F9619FF8B86D011B42D00CF4FC964FF", coll['id']);
        self.assertEquals("PROCESSED", coll['status']);
        # facets
        self.assertEquals(1, len(coll['facets']));
        facet = coll['facets'][0];
        self.assertEquals('Something', facet['label']);
        self.assertEquals(10, facet['count']);
        self.assertEquals(2, facet['negative_count']);
        self.assertEquals(1, facet['positive_count']);
        self.assertEquals(7, facet['neutral_count']);
        self.assertEquals(1, len(facet['attributes']));
        self.assertEquals('Attribute', facet['attributes'][0]['label']);
        self.assertEquals(5, facet['attributes'][0]['count']);
        # themes
        self.assertEquals(1, len(coll['themes']));
        self.assertEquals(1, coll['themes'][0]['phrases_count']);
        self.assertEquals(1, coll['themes'][0]['themes_count']);
        self.assertEquals(0.0, coll['themes'][0]['sentiment_score']);
        self.assertEquals('republican moderates', coll['themes'][0]['title']);
        # entities
        self.assertEquals(1, len(coll['entities']));
        self.assertEquals('WASHINGTON', coll['entities'][0]['title']);
        self.assertEquals('named', coll['entities'][0]['type']);
        self.assertEquals('Place', coll['entities'][0]['entity_type']);
        self.assertEquals(1, coll['entities'][0]['count']);
        self.assertEquals(1, coll['entities'][0]['negative_count']);
        self.assertEquals(1, coll['entities'][0]['positive_count']);
        self.assertEquals(1, coll['entities'][0]['neutral_count']);
        # topics
        self.assertEquals(1, len(coll['topics']));
        self.assertEquals(0, coll['topics'][0]['hitcount']);
        self.assertEquals('concept', coll['topics'][0]['type']);
        self.assertEquals(0.6133076, coll['topics'][0]['sentiment_score']);
        self.assertEquals('Something', coll['topics'][0]['title']);
