...
namespace Semantria.Com.TestUnitApi
{
    ...
    public class SerializerTest
    {
                    ...
                    "<configurations xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">" +
                        "<added>" +
                            "<configuration>" + 
                              ...
                              "<auto_responding>" + config.AutoResponding.ToString().ToLower() + "</auto_responding>" +
                            ...
                            "<configuration>" +
                              ...
                              "<auto_responding>" + clonedConfig.AutoResponding.ToString().ToLower() + "</auto_responding>" +
        ...
        public void testXmlDeserializingConfiguration() 
        {
            ...
            Assert.IsTrue(config.AutoResponding);
        ...
        public void testJsonSerializingConfiguration()
        {
            ...
            String expectedResult =
                    "{\"added\":[{\"auto_responding\":true,\"callback\":\"https:\\/\\/anyapi.anydomain.com\\/processed\\/docs.json\",\"chars_threshold\":80,\"collection\":{\"concept_topics_limit\":5," +
                    ...
                    "\"user_entities_limit\":5},\"is_primary\":true,\"language\":\"English\",\"name\":\"test\",\"one_sentence\":false},{\"auto_responding\":false,\"callback\":null,\"collection\":null,\"document\":null" + 
